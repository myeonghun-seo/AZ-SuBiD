                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <form name="f" method="post" action="/user/insertUserInfo" onsubmit="return doRegUserCheck(this);">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input class="form-control" id="inputName" type="text"
                                                       name="user_nm" placeholder="Enter your name"/>
                                    ...
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid"><a class="btn btn-primary btn-block" href="#" onclick="doRegUserCheck(f)">Create
                                            Account</a></div>
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer text-center py-3">
                                <div class="small"><a href="/logintest">Have an account? Go to login</a></div>
                            </div>
                        </div>
                    </div>
                </div>
